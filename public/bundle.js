...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RepoList = __webpack_require__(231);
	...
	exports['default'] = _react2['default'].createElement(
	  _reactRouter.Route,
	  { path: '/', component: _Main2['default'], history: _reactRouter.hashHistory },
	  _react2['default'].createElement(_reactRouter.IndexRoute, { component: _RepoList2['default'] })
	);
	  ...
	  _createClass(RepoList, [{
	    ...
	    value: function () {
	      function componentDidMount() {
	        ...
	        (0, _helpers.getGitHubRepos)().then(function (repoData) {
	          _this2.setState({
	      ...
	      function render() {
	        return _react2['default'].createElement(
	          ...
	          this.state.repos.map(function (repo, index) {
	            return _react2['default'].createElement(_Repo2['default'], { repo: repo, key: index });
	          })
	        );
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Repo = function (_React$Component) {
	  ...
	  _createClass(Repo, [{
	    key: 'showTopContributor',
	    value: function () {
	      function showTopContributor() {
	        var _this2 = this;

	        (0, _helpers.getTopContributor)(this.props.repo).then(function (topContributor) {
	          _this2.setState({
	      ...
	      return showTopContributor;
	    }()
	  }, {
	    key: 'render',
	    value: function () {
	      function render() {
	        var repoOwner = this.props.repo.owner.login;
	        var repoName = this.props.repo.name;
	        var starCount = this.props.repo.stargazers_count;
	        var repoLink = 'https://github.com/' + repoOwner + '/' + repoName;
	        ...
	        return _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              'span',
	              { className: 'top-contributor-name' },
	              _react2['default'].createElement(
	                'a',
	                { href: 'https://github.com/' + this.state.topContributor },
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.getTopContributor = getTopContributor;
	...
	var API_ADDR = "https://api.github.com";

	function getGitHubRepos() {
	  var topReposEndpoint = API_ADDR + "/search/repositories?per_page=100&q=stars%3A%3E10000";

	  return _axios2["default"].get(topReposEndpoint).then(function (repoData) {
	    return { repos: repoData.data.items };
	  });
	  // TODO - handle error
	}

	function getTopContributor(repo) {
	  var repoOwner = repo.owner.login;
	  var repoName = repo.name;
	  var contributorEndpoint = API_ADDR + "/repos/" + repoOwner + "/" + repoName + "/contributors?per_page=1";

	  // Contributor data is returned in descending order, so we only care
	  // about the first
	  return _axios2["default"].get(contributorEndpoint).then(function (contributorData) {
	    return contributorData.data[0].login;
	  });
	  // TODO - handle error
	}
